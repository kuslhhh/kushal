            ...
            <div className="w-full flex justify-center py-5 pt-36 dark:bg-black">
                <div className="w-2/3 max-sm:w-full flex flex-col items-center">
                    ...
                    <div className="mt-4 px-32 max-sm:px-4">
                        ...
                        >
                            I break things, learn fast, and make shit happen. Deep into code,
                            CS, gaming, and anything that pushes the limits. Addicted to
                            late-night builds, clean code, and crafting slick web experiences.
                    ...
                    <div className="mt-8 flex gap-4">
                        <Link href="https://cal.com/kuslhhh/15min" target="_blank">
